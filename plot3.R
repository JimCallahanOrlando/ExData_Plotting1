### FILE:     plot3.R
### PURPOSE:  Plot #3 of Household Power Consumption data 
...
### Plot 3: Energy sub metering (uncomment next line to save output in Plot3.png)
...
### NOTE: "plot3.png" should have been created in  /GitHub/ExData_Plotting1/
### NOTE: Need to "git add plot3.png".

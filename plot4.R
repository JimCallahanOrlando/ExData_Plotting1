### FILE:     plot4.R
### PURPOSE:  Plot #4 of Household Power Consumption data 
...
### Plot 4: Four (sub)plots in one (uncomment next line to save output in Plot4.png)
png("plot4.png", width=480, height=480)


# par(mfrow = c(2, 2), mar = c(4, 4, 2, 1), oma = c(0, 0, 2, 0))
# Four plots 2 rows x 2 columns (fill by rows, "mfrow")
# "cex" controls character size .20 = 20% of normal
...
### NOTE: "plot4.png" should have been created in  /GitHub/ExData_Plotting1/
### NOTE: Need to "git add plot4.png".
